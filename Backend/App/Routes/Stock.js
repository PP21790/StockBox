...
const {AddStock,getStock,updateStock,deleteStock,detailStock,statusChange,AddBulkStock,activeStock,getStockByService,getStocksByExpiry} = require('../Controllers/Stock')
